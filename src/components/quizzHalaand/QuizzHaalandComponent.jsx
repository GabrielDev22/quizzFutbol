...
import "./QuizzHaalandComponent.css";
import preguntasHalaand from "./preguntasHalaand";

export const QuizzHaalandComponent = () => {
  ...
  const handleAnswerSubmit = (isCorrect, e) => {
    ...
    setTimeout(() => {
      if(preguntaActual === preguntasHalaand.length - 1){
        setIsFinishe(true);
      }else{
    ...
    <div className="containerQuizz">
        <div className="juego-terminado">
          <div className="subcontenedor">
            <span className="puntuacionObtenida">Obtuviste {puntuacion} de {preguntasHalaand.length}{" "}</span>
  ...
  return (
    ...
    <div className="interruptorDeCambio">
      <div className="numero-pregunta">
          <span className="numeroPregunta">Pregunta {preguntaActual + 1} de {preguntasHalaand.length} </span> 
      </div>
      <h2 className="tituloPregunta">{preguntasHalaand[preguntaActual].titulo}</h2>

      <div className="lado-derecho">
            {preguntasHalaand[preguntaActual].opciones.map((respuesta) =>(
