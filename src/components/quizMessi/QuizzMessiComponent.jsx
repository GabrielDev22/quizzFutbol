...
import "./QuizzMessiComponent.css";
import preguntas from "./preguntas";

export const QuizzMessiComponent = () => {
      ...
      <div className="containerQuizz">
          <div className="juego-terminado">
            <div className="subcontenedor">
              <span className="puntuacionObtenida">Obtuviste {puntuacion} de {preguntas.length}{" "}</span>
    ...
    <div className="containerQuizz">
        <div className="interruptorDeCambio">
          <div className="numero-pregunta">
              <span className="numeroPregunta">Pregunta {preguntaActual + 1} de {preguntas.length} </span> 
          </div>
          <h2 className="tituloPregunta">{preguntas[preguntaActual].titulo}</h2>
